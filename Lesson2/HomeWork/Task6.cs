...
namespace HomeWork
{
    partial class Program
    {
        static int Sum (int n) //метод для подсчёта суммы цифр числа.
        {
            ...
            sum = sum + n; //прибавляем оставшееся последнее число к сумме
        ...
        static void Task6()
        {
            ...
            Console.WriteLine("Программа подсчёта количества хороших чисел от 1 до 1 000 000 000. " +
                "\n\"Хорошее\" число - число, которое делится на сумму своих цифр. Реализовать подсчёт времени работы программы, " +
